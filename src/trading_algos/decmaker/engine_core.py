...
class DecmakerAlgorithmCore:
    ...
    def __init__(self, *, container_obj: Any, engine_config: dict[str, Any], label: str) -> None:
        self.engine_config = validate_decmaker_engine_payload(engine_config, label=label)
        ...
        self.max_percent_higher_price_buy = self.engine_config["max_percent_higher_price_buy"]
        self.max_percent_lower_price_sell = self.engine_config["max_percent_lower_price_sell"]
