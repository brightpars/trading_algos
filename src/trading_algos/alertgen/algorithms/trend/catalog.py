...
def register_trend_alert_algorithms() -> None:
    specs = [
        ...
        AlertAlgorithmSpec(
            key="OLD_double_red_confirmation_NEW_channel_breakout_with_confirmation",
            name="OLD Double Red Confirmation NEW Channel Breakout With Confirmation",
            catalog_ref="algorithm:7",
        ...
        AlertAlgorithmSpec(
            key="OLD_low_anchored_boundary_breakout_NEW_breakout_donchian_channel",
            name="OLD Low-Anchored Boundary Breakout NEW Breakout Donchian Channel",
            catalog_ref="algorithm:6",
        ...
        AlertAlgorithmSpec(
            key="OLD_rolling_channel_breakout_NEW_breakout_donchian_channel",
            name="OLD Rolling Channel Breakout NEW Breakout Donchian Channel",
            catalog_ref="algorithm:7",
