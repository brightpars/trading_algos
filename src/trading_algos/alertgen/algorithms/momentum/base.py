...
class BaseMomentumAlertAlgorithm(BaseAlertAlgorithm, ABC):
    def __init__(
        self,
        alg_name: str,
        *,
    ...
    def _calculate_state(self) -> MomentumSignalState:
        """Return the current momentum state for the latest bar."""
    ...
    def _reason_codes(self, state: MomentumSignalState) -> tuple[str, ...]:
    ...
    def _record_state(self, state: MomentumSignalState) -> None:
