...
def build_earnings_quality_strategy(symbol, report_base_path, alg_param, **_kwargs):
    del report_base_path
    algorithm = build_factor_portfolio_algorithm(
        algorithm_key="earnings_quality_strategy",
        symbol=symbol,
        alg_name="earnings_quality_strategy",
    ...
    algorithm.catalog_ref = "algorithm:111"
    return algorithm
