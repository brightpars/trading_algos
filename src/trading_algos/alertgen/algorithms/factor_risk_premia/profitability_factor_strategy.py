...
def build_profitability_factor_strategy(symbol, report_base_path, alg_param, **_kwargs):
    del report_base_path
    algorithm = build_factor_portfolio_algorithm(
        algorithm_key="profitability_factor_strategy",
        symbol=symbol,
        alg_name="profitability_factor_strategy",
    ...
    algorithm.catalog_ref = "algorithm:110"
    return algorithm
