...
def build_dividend_yield_strategy(symbol, report_base_path, alg_param, **_kwargs):
    del report_base_path
    algorithm = build_factor_portfolio_algorithm(
        algorithm_key="dividend_yield_strategy",
        symbol=symbol,
        alg_name="dividend_yield_strategy",
    ...
    algorithm.catalog_ref = "algorithm:107"
    return algorithm
