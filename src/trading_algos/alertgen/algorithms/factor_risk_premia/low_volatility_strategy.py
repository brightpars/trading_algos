...
def build_low_volatility_strategy(symbol, report_base_path, alg_param, **_kwargs):
    del report_base_path
    algorithm = build_factor_portfolio_algorithm(
        algorithm_key="low_volatility_strategy",
        symbol=symbol,
        alg_name="low_volatility_strategy",
        subcategory="low",
        alg_param=alg_param,
    ...
    algorithm.catalog_ref = "algorithm:100"
    return algorithm
