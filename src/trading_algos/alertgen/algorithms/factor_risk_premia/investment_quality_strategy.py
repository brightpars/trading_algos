...
def build_investment_quality_strategy(symbol, report_base_path, alg_param, **_kwargs):
    del report_base_path
    algorithm = build_factor_portfolio_algorithm(
        algorithm_key="investment_quality_strategy",
        symbol=symbol,
        alg_name="investment_quality_strategy",
    ...
    algorithm.catalog_ref = "algorithm:112"
    return algorithm
