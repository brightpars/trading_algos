...
class BaseVolatilityAlertAlgorithm(BaseAlertAlgorithm, ABC):
    def __init__(
        self,
        alg_name: str,
        *,
    ...
    def _calculate_state(self) -> VolatilitySignalState:
        """Return the current volatility state for the latest bar."""
    ...
    def _reason_codes(self, state: VolatilitySignalState) -> tuple[str, ...]:
    ...
    def _record_state(self, state: VolatilitySignalState) -> None:
