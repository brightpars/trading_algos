...
class BasePatternAlertAlgorithm(BaseAlertAlgorithm, ABC):
    def __init__(
        self,
        alg_name: str,
        *,
    ...
    def _calculate_state(self) -> PatternSignalState:
        """Return the current pattern state for the latest bar."""
    ...
    def _reason_codes(self, state: PatternSignalState) -> tuple[str, ...]:
    ...
    def _record_state(self, state: PatternSignalState) -> None:
