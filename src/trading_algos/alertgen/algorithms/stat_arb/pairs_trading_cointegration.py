...
class PairsTradingCointegrationAlertAlgorithm(BaseStatArbAlertAlgorithm):
    catalog_ref = "algorithm:39"


def build_pairs_trading_cointegration_algorithm(
    *,
    algorithm_key: str,
    symbol: str,
...
) -> PairsTradingCointegrationAlertAlgorithm:
    ...
    return PairsTradingCointegrationAlertAlgorithm(
        algorithm_key=algorithm_key,
        symbol=symbol,
        alg_name="pairs_trading_cointegration",
        family="stat_arb",
        subcategory="pairs",
        rows=rows,
    )
